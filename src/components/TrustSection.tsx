...
const TrustSection = () => {
  ...
  return <section className="py-20 bg-safezone-navy">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => <Card key={index} className="p-6 bg-white/10 backdrop-blur-sm border-white/20 text-white">
              {/* Quote Icon */}
              <div className="mb-4">
